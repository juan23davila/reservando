...
Aplicacion.prototype.dibujarCiudades = function() {
    ...
    this.listado.restaurantesSinRepetir().forEach(function(ciudad) {
...
Aplicacion.prototype.dibujarRubros = function() {
    ...
    this.listado.rubrosSinRepetir().forEach(function(rubro) {
...
Aplicacion.prototype.dibujarHorarios = function() {
    ...
    this.listado.horariosSinRepetir().forEach(function(horario) {
